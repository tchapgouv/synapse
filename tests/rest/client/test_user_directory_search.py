...
class UserDirectorySearchTestCase(unittest.HomeserverTestCase):
    ...
    def test_search_with_token(self) -> None:
        ...
        self.assertIn("@alice:test", [result["user_id"] for result in initial_channel.json_body["results"]])
        ...
        get_federated_results_mock.assert_called_with("@bob:test", "test", 10, search_token)
